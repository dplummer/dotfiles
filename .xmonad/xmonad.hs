...
--
myModMask       = mod4Mask -- use the super key instead
...
manageScratchPad = scratchpadManageHook (W.RationalRect 0.125 0.125 0.75 0.75)
...
myConfig = defaultConfig {
      ...
      -- hooks, layouts
        -- layoutHook         = myLayout,
        layoutHook         = avoidStruts $ myLayout, -- WAT
        manageHook         = manageDocks <+> myManageHook, -- WAT
